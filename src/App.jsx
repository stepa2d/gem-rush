...
const COL=[{f:"#E53935",l:"#FF8A80",d:"#B71C1C",n:"cherry",img:"/fruits/cherry.png"},{f:"#FDD835",l:"#FFF9C4",d:"#F9A825",n:"lemon",img:"/fruits/lemon.png"},{f:"#FF8F00",l:"#FFE0B2",d:"#E65100",n:"orange",img:"/fruits/orange.png"},{f:"#7B1FA2",l:"#CE93D8",d:"#4A148C",n:"plum",img:"/fruits/plum.png"},{f:"#43A047",l:"#A5D6A7",d:"#1B5E20",n:"pear",img:"/fruits/pear.png"},{f:"#E91E63",l:"#F48FB1",d:"#880E4F",n:"pomegranate",img:"/fruits/pomegranate.png"}];
const fruitImages=[];
const fruitImagesLoaded={current:false};
(function loadFruitImages(){COL.forEach((c,i)=>{const img=new Image();img.src=c.img;img.onload=()=>{fruitImages[i]=img;if(fruitImages.filter(Boolean).length===FC)fruitImagesLoaded.current=true};fruitImages[i]=null})})();
...
function drawFruit(ctx,fi,cx,cy,sz){
  const idx=fi%FC;const fc=COL[idx]||COL[0];const img=fruitImages[idx];
  if(img){const s=sz*2.2;ctx.drawImage(img,cx-s/2,cy-s/2,s,s)}
  else{ctx.fillStyle=fc.f;ctx.beginPath();ctx.arc(cx,cy,sz*.8,0,Math.PI*2);ctx.fill()}
}
